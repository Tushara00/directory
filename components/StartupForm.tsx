  ...
  return (
    <form action={formAction} className="startup-form">
      ...
      <div>
        ...
        <Input id="category" name="category" className="startup-form-input" required placeholder="Startup category" />
      ...
      <div>
        ...
        <Input id="link" name="link" className="startup-form-input" required placeholder="Startup image URL" />
